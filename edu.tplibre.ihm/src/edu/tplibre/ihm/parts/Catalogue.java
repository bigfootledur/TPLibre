...
public class Catalogue implements Observer {
	...
	public void createComposite(Composite parent) {
		...
		ServiceReference<MagasinCommande> magasinServices = null;
		magasinServices = ctx.getServiceReference(MagasinCommande.class);
		MagasinCommande magasin = ctx.getService(magasinServices);
